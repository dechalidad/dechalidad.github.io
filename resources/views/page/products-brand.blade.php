...
<div class="content-wrapper sub-page all-page" id="product-all-page">
	<div class="content">
		...
		<div class="fullwidth-master section-1 section-header sm:h-100vh sm:d-flex sm:ai-end">
			<div class="header-slider-item lazy pos-r max-w-100% mx-10 mt-40 sm:mx-0" style="background-image: url('<?php echo url('/assets/images/banner/products-cat.jpg') ?>">
					...
					<div class="col col-12">
						...
						<div class="row mt-10 jc-center fw-w sm:fw-w">
							...
							$arr = array(
								'0' => array(
									'alt'     => 'cat comfy',
									'image'	  => 'cat-catcomfy.png',
								),
								'1' => array(
									'alt'     => 'kittie bittie',
									'image'	  => 'cat-kittie.png',
								),
								'2' => array(
									'alt'     => 'cat choize',
									'image'	  => 'cat-catchoize.png',
								),
								'3' => array(
									'alt'     => 'lezato',
									'image'	  => 'cat-lezato.png',
								),
								'4' => array(
									'alt'     => 'Me-o',
									'image'	  => 'cat-meo.png',
							...
							?>
								<div class="col col-2-4 mb-6 sm:col-6">
									<div class="px-4">
										<div class="d-flex ai-center jc-center w-100% h-28 bd-rs-3 bg-dark-contrast cur-p make_transition" data-transition-to="{{ url('products') }}">
											<img src="<?php echo url('/assets/images/brand/' . $value['image']) ?>" alt="<?= $value['alt'] ?>" class="logo h-100% lazy">
										</div>
									</div>
								</div>
							<?php } ?>
							...
							?>
								<div class="col col-2-4 mb-6 sm:col-6">
									<div class="px-4 d-flex ai-center jc-center fd-col">
										<div class="d-flex ai-center jc-center w-36 h-36 bd-rs-36 bg-dark-contrast cur-p make_transition" data-transition-to="{{ url('products') }}">
											<div class="d-flex ai-center jc-center w-28 h-28 bd-rs-28 of-h bg-medium">
												<img src="<?php echo url('/assets/images/food-type/' . $value['image']) ?>" alt="<?= $value['alt'] ?>" class="logo h-100% lazy">
											</div>
										</div>
										<h6 class="tc-primary-500 ta-center ff-1-bd txtf-c mt-2"><?= $value['alt'] ?></h6>
									</div>
								</div>
							<?php } ?>
						</div>
