					...
					<div class="col col-6 pl-0 sm:col-12">
						<div class="t-n-s" data-aos="fade-up">
							<div class="d-flex ai-center op-80% mb-4">
								...
								<div>
									<p class="p-sm ff-2-bd ml-4 tc-primary-500">About Us</p>
								</div>
							</div>
							<div class="h3 ff-1-bd tc-primary-500 max-w-80% sm:h6 sm:max-w-100%">Your Lovely Pets Perfect Companion.</div>
						</div>
					</div>
					<div class="col col-6 pr-0 sm:col-12">
						...
						<div class="ml-20 pt-10 sm:ml-0 sm:mt-4 sm:pt-0">
							<p class="p-lg tc-primary-400 max-w-85% ml-2 mb-6 sm:p-md sm:ml-0" data-aos="fade-up">
								We are part of the Charoen Pokphand (CP) Group, PCG was built to expand and support Charoen Pokphand Group's specialization in providing food for your lovely pet, from cats, dogs, birds, and many more.
							</p>
							<button class="btn bg-link-500 tc-link-contrast py-3 bd-n bd-rs-8 make_transition" id="about-us" data-transition-to="{{ url('en/about') }}" data-aos="fade-up">
								<span class="text ff-1-bd px-8">Know Us More</span>
							</button>
						</div>
					</div>
				</div>
					...
					<div class="col col-8 sm:col-12 sm:pt-20 sm:mb-10">
						<div class="d-flex ai-center h-100%">
							<div class="t-n-s sm:d-flex sm:fd-col sm:ai-center">
								...
								<div class="h3 ff-1-bd tc-dark-contrast txtf-c max-w-75% sm:max-w-100% sm:h6 sm:ta-center" data-aos="fade-up">Understand what they are trying to say.</div>
							</div>
						</div>
					</div>
					<div class="col col-4 sm:col-12 sm:pt-20 sm:pb-10">
						<div class="d-flex ai-end jc-center h-100% sm:ai-start">
							<button class="btn d-flex fd-col ai-center jc-center bg-n bd-n mb-28 sm:mb-0 overlay_toggle" id="quiz-wrapper" data-aos=" fade-up">
								...
								<span class="text ff-1-bd h6 tc-primary-500 mt-5">Play Now</span>
							</button>
						</div>
					</div>
				</div>
			...
			<div class="inner">
				<div class="t-n-s d-flex fd-col ai-center mb-10">
					<div class="d-flex ai-center op-80%" data-aos="fade-up">
						...
						<div>
							<p class="p-sm ff-2-bd mx-4 tc-primary-500 ta-center">Guaranteed Product Quality</p>
						</div>
						<div class="h-2px w-20 bg-primary-500 sm:w-10"></div>
					</div>
					<div class="h3 ff-1-bd tc-primary-500 max-w-50% txtf-c ta-center mt-6 mb-8 sm:h6 sm:max-w-100%" data-aos="fade-up">
						The right nutrition for the lovely one</div>
					<p class="p-lg tc-primary-400 max-w-40% ta-center sm:p-md sm:max-w-100%" data-aos="fade-up">
						We concentrate all our expertise and passion to provide them with the best health nutrition.
					</p>
				</div>
		...
		<div class="fullwidth-master section-5 mt-20 sm:mt-10">
			...
			<div class="inner">
				<div class="row ai-end mb-10 sm:fd-col">
					<div class="col col-8 sm:col-12">
						<div class="t-n-s">
							<div class="d-flex ai-center op-80% mb-4" data-aos="fade-up">
								<div class="h-2px w-20 bg-primary-500"></div>
								<div>
									<p class="p-sm ff-2-bd ml-4 tc-primary-500">News, Events and Articles</p>
								</div>
							</div>
							<div class="h3 ff-1-bd tc-primary-500 max-w-90% sm:h6 sm:max-w-100%" data-aos="fade-up">Don't Miss It, Our Latest Information.</div>
						</div>
					</div>
					<div class="col col-4 sm:col-12 sm:d-none">
						<div class="d-flex jc-end">
							...
							<button class="btn bg-link-500 tc-link-contrast py-3 bd-n bd-rs-8 make_transition" id="news-all" data-transition-to="{{ url('en/news') }}" data-aos="fade-up">
								<span class="text ff-1-bd px-8">See More</span>
							</button>
						</div>
					</div>
				</div>
				<div class="complex-news-slider-wp" data-aos="fade-up">
					<div class="slider complex-news-slider" data-type="responsive" data-minimum=3>
						<div class="row">
							...
							?>
								<div class="col col-4">
									<div class="news-slider-item make_transition cur-p" id="news-detail" data-transition-to="{{ url('en/news-detail/'.$value->id) }}">
				...
				<div class="d-none jc-center sm:d-flex mt-8">
					...
					<button class="btn bg-link-500 tc-link-contrast py-3 bd-n bd-rs-8 make_transition sm:py-1" id="news-all" data-transition-to="{{ url('en/news') }}" data-aos="fade-up">
						<span class="text ff-1-bd px-8 sm:px-4">See More</span>
					</button>
				...
				<div class="row ai-end sm:fw-w sm:fd-col">
					<div class="col col-6 py-20 sm:col-12 sm:pb-0">
						<div class="t-n-s mb-12 sm:mb-8">
							...
							<div class="h3 ff-1-bd tc-dark-contrast max-w-90% sm:h6 sm:max-w-100%" data-aos="fade-up">What our loyal customers say about us.</div>
						</div>
			...
			<div class="inner">
				<div class="t-n-s mb-10">
					<div class="d-flex ai-center op-80% mb-4" data-aos="fade-up">
						<div class="h-2px w-20 bg-primary-500"></div>
						<div>
							<p class="p-sm ff-2-bd ml-4 tc-primary-500">Where to Buy</p>
						</div>
					</div>
					<div class="h3 ff-1-bd tc-primary-500 max-w-70% txtf-c sm:h6 sm:max-w-100%" data-aos="fade-up">Available at the nearest <br /> Online and Offline outlets.</div>
				</div>
						...
						<div class="col col-8 sm:col-12 sm:mb-8">
							<div class="t-n-s">
								<div class="d-flex ai-center mb-4" data-aos="fade-up">
									<div class="h-2px w-20 bg-dark-contrast op-80%"></div>
									<div>
										<p class="p-sm ff-2-bd ml-4 tc-dark-contrast">Stay Up to Date</p>
									</div>
								</div>
								<div class="h5 ff-1 tc-dark-contrast max-w-90% txtf-c sm:h6 sm:max-w-100%" data-aos="fade-up">latest news & promos, <br class="sm:d-none" /> directly to your email.</div>
							</div>
						</div>
						...
						<div class="col col-8 sm:col-12 sm:mb-10">
							...
							<div class="row mt-8 pl-24 sm:fw-w sm:pl-0">
								<div class="col col-4 sm:col-6 sm:mb-8">
									<p class="p-sm ff-2 txtf-u ls-3 mb-2 tc-primary-500 op-80%">products</p>
									<div class="p-xl link ff-1 mb-3 tc-primary-500 make_transition cur-p" id="catalog" data-transition-to="{{ url('products/1/1/brand') }}">Catalog</div>
									<div class="p-xl link ff-1 mb-3 tc-primary-500 make_transition cur-p" id="products" data-transition-to="{{ url('products-intro') }}">Category</div>
									<div class="p-xl link ff-1 mb-3 tc-primary-500 make_transition cur-p" id="news" data-transition-to="{{ url('news') }}">Article</div>
								</div>
								<div class="col col-4 sm:col-6 sm:mb-8">
									<p class="p-sm ff-2 txtf-u ls-3 mb-2 tc-primary-500 op-80%">about</p>
									<div class="p-xl link ff-1 mb-3 tc-primary-500 make_transition cur-p" id="about" data-transition-to="{{ url('about') }}">About Us</div>
									<div class="p-xl link ff-1 mb-3 tc-primary-500 make_transition cur-p" id="contact" data-transition-to="{{ url('contact') }}">Our Contact</div>
					...
					<div class="quizBox">
						...
						<div class="buttonArea mt-8 d-flex jc-center">
							<button class="btn bg-secondary-500 tc-link-contrast h-12 px-6 bd-n bd-rs-8 d-flex ai-center jc-center hidden" id="next">
								<span class="text ff-1-bd">Next</span>
					...
					<div class="resultPage1 pos-r">
						...
						<div class="resultBox pos-r zi-2">
							<div class="d-flex fd-col ai-center mb-10">
								...
								<div class="text ff-1-bd h3 tc-secondary-500 mt-8">Wow, Congratulations!</div>
								<p class="p-lg  max-w-75% txtf-c ta-center mt-6 sm:max-w-100%"><span class="op-50%">You are really great at understanding </span> <br class="d-none" /> <span class="op-50%">what's your pet trying to say. Based on that, here's:</span><span class="tc-secondary-500"> our product recommendation for your lovely pet!</span></p>
							</div>
							<!-- <div class="block"></div> -->
							...
							<div class="d-flex fd-col ai-center jc-center mt-8">
								<div class="text ff-1 h6 tc-primary-500 mb-6 ta-center txtf-c max-w-45% sm:max-w-100% sm:p-md">There's still more of our products for your pet!</div>
								<button class="btn bg-secondary-500 tc-dark-contrast py-3 bd-n bd-rs-8 make_transition" data-transition-to="{{ url('en/products-intro') }}">
									<span class="text ff-1-bd px-8">See More</span>
								</button>
							</div>
						</div>
