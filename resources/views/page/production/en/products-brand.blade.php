					...
					<div class="col col-12">
						<div class="t-n-s d-flex fd-col ai-center mb-20">
							<div class="d-flex ai-center op-80% mb-2">
								...
								<div>
									<p class="p-sm ff-2-bd mx-4 tc-primary-500 ta-center">Preferred Brand</p>
								</div>
								<div class="h-2px w-20 bg-primary-500 sm:w-10"></div>
							</div>
							<div class="h3 ff-1-bd max-w-50% ta-center tc-primary-500 txtf-c sm:h4 sm:max-w-100%">The Best Products from the Best Brands</div>
						</div>
						<div class="row mt-10 jc-center fw-w sm:fw-w">
							...
							?>
								<div class="col col-2-4 mb-6 sm:col-6">
									<div class="px-4">
										<div class="d-flex ai-center jc-center w-100% h-28 bd-rs-3 bg-dark-contrast cur-p make_transition" data-transition-to="{{ url('en/products/'.$animal->id.'/'.$value->id.'/brand') }}">
					...
					<div class="col col-12">
						<div class="t-n-s d-flex fd-col ai-center mb-20">
							<div class="d-flex ai-center op-80% mb-2">
								<div class="h-2px w-20 bg-primary-500"></div>
								<div>
									<p class="p-sm ff-2-bd mx-4 tc-primary-500 ta-center">Food Type</p>
								</div>
								<div class="h-2px w-20 bg-primary-500 sm:w-10"></div>
							</div>
							<div class="h3 ff-1-bd max-w-50% ta-center tc-primary-500 txtf-c sm:h4 sm:max-w-100%">Come on, choose the right food for your sweet one</div>
						</div>
						<div class="row mt-10 jc-center fw-w sm:fw-w">
							<?php
							...
							?>
								<div class="col col-2-4 mb-6 sm:col-6">
									<div class="px-4 d-flex ai-center jc-center fd-col">
										<div class="d-flex ai-center jc-center w-36 h-36 bd-rs-36 bg-dark-contrast cur-p make_transition" data-transition-to="{{ url('en/products/'.$animal->id.'/'.$value->id.'/food') }}">
