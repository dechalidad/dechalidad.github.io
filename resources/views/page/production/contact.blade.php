					...
					<div class="row sm:fw-w">
						...
						<div class="col col-9 sm:col-12">
							<div class="h3 ff-1-bd tc-primary-500 max-w-80% -mt-4 sm:h4 sm:max-w-100%">
								<span>Informasi <br class="sm:d-none" /> & Konsultasi</span>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col col-6 pl-0 sm:col-12">
						<div class="t-n-s">
							<div class="title mb-10">
								<div class="h4 ff-1 tc-primary-500 max-w-90% txtf-c sm:max-w-100%">Kami berharap dapat membantu <br class="sm:d-none" />Anda dengan semua kebutuhan <br class="sm:d-none" /> si manis — <span class="ff-1-bd">Sahabat Sempurna.</span><br /></div>
							</div>
						</div>
					</div>
