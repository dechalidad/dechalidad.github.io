...
<head>
    ...
    <title>PERFECT COMPANION - Login</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Enter credentials to Login</h1>
                                        @if (session('status'))
                                    ...
                                    <form class="user" method="POST" action="{{ url('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="user" name="username" placeholder="Username" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-dark btn-user btn-block">
                                            ...
                                            <span class="text" style="font-size: 14pt;">Login</span>
                                        </button>
                                    </form>
                                    <br>
                                </div>
