...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Food Type</h1>
</div>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form - Food Type </h6>
    </div>
    <div class="card-body row">
        <div class="col-xl-8 col-lg-7">
            <form method="POST" class="user" accept-charset="utf-8" enctype="multipart/form-data" action="<?= ($action == 'create') ? url('master-food') : url('master-food/' . $data['id']) ?>">
                @if ($action == 'edit')
                @method('patch')
                @endif
                @csrf
                ...
                <a href="<?php echo url('/master-food') ?>" class="btn btn-secondary">Back</a>
            </form>
        </div>
    </div>
</div>
