...
<body class="master-body" id="dekstop" data-barba="wrapper">
	...
	<div class="navbar py-4 hide-on-scroll master_body_navbar">
		<div class="px-20 d-flex ai-center pos-r zi-1 sm:px-6 sm:jc-center">
			<img src="<?php echo url('/assets/images/logo/logo_pcg.png') ?>" alt="" class="logo zi-8 lazy cur-p make_transition" id="index" data-transition-to="{{ url('/en') }}">
			<div class="d-flex ai-center ml-a sm:d-none md:d-none">
				<img src="<?php echo url('/assets/images/icons/indonesia.png') ?>" alt="indonesia" class="h-10 make_transition cur-p" id="to-indonesia" data-transition-to="{{ url('/') }}">
				<span class="px-4 op-25%">|</span>
				<img src="<?php echo url('/assets/images/icons/english.png') ?>" alt="english" class="h-10">
			</div>
					...
					<div class="row">
						<div class="col col-12">
							...
							<div class="d-flex fd-col">
								<div class="h5 ff-1 txtf-c tc-primary-500 mb-4 make_transition cur-p" id="index" data-transition-to="{{ url('/en') }}">Home</div>
								<div class="h5 ff-1 txtf-c tc-primary-500 mb-4 make_transition cur-p" id="about" data-transition-to="{{ url('en/about') }}">About Us</div>
								<div class="h5 ff-1 txtf-c tc-primary-500 mb-4 make_transition cur-p" id="products" data-transition-to="{{ url('en/products-intro') }}">All Products</div>
								<div class="h5 ff-1 txtf-c tc-primary-500 mb-4 make_transition cur-p" id="news" data-transition-to="{{ url('en/news') }}">News & Events</div>
								<!-- <div class="h5 ff-1 txtf-c tc-primary-500 mb-4">Komunitas</div> -->
								<div class="h5 ff-1 txtf-c tc-primary-500 make_transition cur-p" id="contact" data-transition-to="{{ url('en/contact') }}">Contact</div>
							</div>
						</div>
					</div>
			...
			<div class="inner h-100vh">
				<div class="row h-100% ai-center">
					<div class="col col-12">
						...
						<div class="h6 mb-4 tc-medium-tint d-flex ai-center sm:d-block sm:p-lg sm:mb-2"><span class="tc-secondary-500 mr-2">Which product you're looking for?</span> Here let us help!</div>
						<div class="d-flex ai-center">
							<div class="form-control mb-25 f-1">
								<input type="text" name="product_name" id="input_search" class="input bd-tl-rs-2 bd-bl-rs-2 bg-secondary-100 bd-n py-3 px-4 w-100% p-lg" placeholder="Looking for something...">
...
<script>
	...
	$('#btn-search-product').on('click', function() {
		...
		if (product_name == '') {
			...
			window.location.href = `{{ url('en/search-product/${product_name}') }}`
		}
	})

	// $(document).ready(function() {
	// 	var pathname = window.location.pathname;
	// 	var pathnameToIndo = pathname.replace("/en", '');
	// 	console.log(">>> pathname : " + pathname, pathnameToIndo);

	// 	$('#to-indonesia').attr("data-transition-to", pathnameToIndo);
	// });
</script>
